...
# Data Sets
The datasets used for this analysis comprises of the information on the following parameters:
1. Orders
2. Products
3. Departments
4. Customers
...
# Tools
Python Libraries used for this project are as follows:
1. pandas: Data manipulation and analysis
2. numpy: Numerical computing and arrays
3. os: File and directory operations
4. dask: Large-scale parallel data processing
5. seaborn: Statistical data visualization
6. matplotlib: Plotting and data visualization
7. scipy: Scientific and statistical computing


# Resources
Instacart is a real company that’s made their data available online, however 'Customer' dataset and 'Prices' column within 'Products' dataset is fabricated for the purposes of Career Foundry's Data Analytics program.
